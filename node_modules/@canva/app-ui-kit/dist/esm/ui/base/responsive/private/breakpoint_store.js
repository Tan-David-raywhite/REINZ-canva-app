...
import { Breakpoint, largeBreakpoint, mediumBreakpoint, smallBreakpoint, xLargeBreakpoint } from '../breakpoints';
const MEDIA_QUERIES = [
    `(min-width: ${smallBreakpoint}px)`,
    `(min-width: ${mediumBreakpoint}px)`,
    `(min-width: ${largeBreakpoint}px)`,
    `(min-width: ${xLargeBreakpoint}px)`
];
