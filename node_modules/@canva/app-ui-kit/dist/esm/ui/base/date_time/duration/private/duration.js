...
export const Duration = observer(function Duration({ seconds: secondsProp, value, format = 'medium', className, ariaLabel }) {
...
export function formatDuration(secondsOrDuration, format = 'medium') {
    const seconds = secondsOrDuration instanceof TimeDuration ? secondsOrDuration.toSeconds() : secondsOrDuration;
