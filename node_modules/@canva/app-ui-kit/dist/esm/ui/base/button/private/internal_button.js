...
import { shimmerStyles } from '../../shimmer/shimmer';
...
const getButtonContent = (props)=>{
    ...
    if (props.loading) content.push(_jsxs("span", {
        className: styles.loadingIconWrapper,
        "data-testid": ButtonTestIds.loadingIconWrapper,
        children: [
            _jsx(LoadingIcon, {
                size: effectiveIconSize
            }),
...
const getShimmerOverlayColorClass = (variant, disabled)=>{
    if (disabled && variant !== 'contrast') return shimmerStyles.shimmerOverlayColorDisabled;
    switch(variant){
        case 'primary':
        case 'contrast':
        case 'critical':
            return shimmerStyles.shimmerOverlayColorSaturated;
        default:
            return undefined;
    }
};
const useClassName = (isAnchor, { children, alignment = 'center', active, selected, pressed, disableActiveStyle, disclosure, loading, loadingVariant, disabled, displayType, stretch, variant, hideOutline, iconPosition, shape, size, elevation, expandClickableArea, icon, iconSize })=>{
    ...
    const enableButtonLoadingShimmer = useEaselFlags().enableButtonLoadingScan;
    ...
    return classNames(styles.base, {
        ...
        [styles.displayBlock]: displayType === 'block',
        ...
        [styles.resting]: elevation === 'resting',
        [styles.raised]: elevation === 'raised',
        ...
        [styles.hideLoadingIndicator]: loading && loadingVariant === 'shimmer',
        [shimmerStyles.shimmerOverlay]: loading && loadingVariant === 'shimmer',
        ...
        [styles.xlargeWidth]: trueSize === 'xlarge' && squareSizing
...
export const ButtonInner = observer(function ButtonInner({ ref, displayType = 'inline', ...props }) {
    const buttonRef = React.useRef(null);
    React.useImperativeHandle(ref, ()=>createBasicHTMLHandle(buttonRef), []);
    const composedRef = composeRefs(buttonRef, toCallbackRef(props.buttonRef));
    ...
    return _jsx(ElevatedWrapper, {
        ...
        children: _jsx("button", {
            ...
            "data-testid": props.testId ?? ButtonTestIds.base,
            form: props.form,
...
export const AnchorInner = observer(function AnchorInner({ ref, displayType = 'inline', ...props }) {
    const anchorRef = React.useRef(null);
    React.useImperativeHandle(ref, ()=>createBasicHTMLHandle(anchorRef), []);
    const composedRef = composeRefs(anchorRef, toCallbackRef(props.buttonRef));
...
export function CircleButtonWithLabel({ variant, children, tooltipLabel: tooltipLabelProp, ref, id, ...props }) {
    const defaultButtonId = React.useId();
...
const ElevatedWrapper = observer(function ElevatedWrapper(props) {
    if (props.enabled && props.elevation !== 'none') return _jsx("span", {
        className: classNames(styles.elevatedWrapper, props.containerClassName, {
            [styles.stretch]: props.stretch,
            [styles.displayBlock]: props.displayType === 'block',
            [styles.tinyElevatedWrapper]: props.size === 'tiny',
            [styles.xsmallElevatedWrapper]: props.size === 'xsmall',
            [styles.smallElevatedWrapper]: props.size === 'small',
            [styles.largeElevatedWrapper]: props.size === 'large',
            [styles.xlargeElevatedWrapper]: props.size === 'xlarge',
            [styles.circleShape]: props.shape === 'circle',
            [styles.resting]: props.elevation === 'resting',
            [styles.raised]: props.elevation === 'raised'
        }),
