...
function useReaction(expression, initialValue) {
    ...
    const expressionEffectEvent = React.useEffectEvent(expression);
    React.useEffect(()=>{
        return reaction(expressionEffectEvent, (value)=>setState(value), {
...
export function useIsKeyboardAccessMode() {
