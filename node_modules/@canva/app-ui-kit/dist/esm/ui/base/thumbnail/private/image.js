...
import { LegacyPlaceholder, LegacyPlaceholderFader } from '../../placeholder/placeholder';
...
const LoadableImage = ({ src, loadingState, placeholder = _jsx(ImagePlaceholder, {
    ...
    return _jsx(LegacyPlaceholderFader, {
...
export const ImagePlaceholder = ({ src, index, shape = 'sharpRectangle', disableAnimations })=>{
    const placeholder = _jsx(LegacyPlaceholder, {
        shape: shape,
        index: index,
