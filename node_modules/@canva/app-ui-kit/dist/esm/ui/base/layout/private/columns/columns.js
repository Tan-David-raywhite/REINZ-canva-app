...
const columnFlexPropertyMap = {
    default: customProperties.columnFlex,
    smallUp: customProperties.smallUpColumnFlex,
    mediumUp: customProperties.mediumUpColumnFlex,
    largeUp: customProperties.largeUpColumnFlex,
    xLargeUp: customProperties.xLargeUpColumnFlex
};
...
export function Column(
    { width = 'fluid', display = 'block', children, tagName: TagName = 'div', ref, ...rest }
) {
    return _jsx(TagName, {
        className: classNames(styles.column, {
            [styles.displayFlex]: display === 'flex'
        }),
        style: generateStyle(columnFlexPropertyMap, width, getColumnFlexValue),
