...
export const ExtendedBadgeVisibilityTrigger = observer(function ExtendedBadgeVisibilityTrigger({ children, tagName: TagName = 'div', role, className, onMouseEnter, onMouseLeave, onMouseUp, onMouseDown, ariaLabel, ariaLabelledBy, ariaDescribedBy, ref }) {
    return _jsx(TagName, {
