...
const BaseBadge = React.memo(
    function BaseBadge({ className, icon, text, shape = 'regular', size = 'tiny', tone, ariaLabel, border = 'none', width, ariaHidden = false, testId }) {
        return _jsxs(Box, {
            tagName: "span",
...
const UnderlayBadge = React.memo(function UnderlayBadge(props) {
