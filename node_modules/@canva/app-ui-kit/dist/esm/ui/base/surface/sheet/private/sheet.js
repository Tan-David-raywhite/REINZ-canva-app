...
import { SurfaceHeaderCloseButton, SurfaceHeaderContextProvider } from '../../header/header';
import { ContentContainer } from '../../internal/content_container';
import { DismissArea } from '../../internal/dismiss_area/dismiss_area';
...
import { useSheetControls, useSheetDrag, useSheetPositioner, useSheetScroll } from '../behavior/behavior';
            ...
            _jsx(Layer, {
                ...
                children: _jsx("div", {
                    className: classNames({
                        [styles.transitioning]: transition.animated && !transition.open,
                        [styles.visible]: transition.opening || transition.open
                    }),
...
function SheetInner({ handleRef, height = 'auto', scrollToResizeBelow, onHeightChange, onRequestClose, onScroll, backdropVisible, handleSafeAreaInsetBottom = true, animateResize, id, children, header, headerDivider = 'always', footer, footerDivider = 'never', handleVisible = 'auto', _tempVideoOnlyIgnoreVirtualKeyboardOffset = false, ariaDescribedBy, ariaLabel, ariaLabelledBy, autoFocus, captureFocus, role }) {
    const heights = React.useMemo(()=>ensureArray(height), [
        height
    ]);
    ...
    React.useImperativeHandle(handleRef, ()=>createSheetImperativeHandle(contentRef, snapPoints, setSnapPointIndex), [
        setSnapPointIndex,
        snapPoints
    ]);
    const { handleSnap, cancelSnap, scheduleUpdate, setDragOffset, ref: snapAnimationRef } = useSheetPositioner(animateResize);
    ...
    const { ref: scrollableRef, onScroll: onScrollableScroll, showHeaderBorder: showHeaderDivider, showFooterBorder: showFooterDivider } = useSurfaceDividers({
        headerDivider,
        footerDivider
    });
    ...
    if (hasDecorations) content = _jsxs(_Fragment, {
        children: [
            header != null && _jsx(SurfaceHeaderContextProvider, {
                alignText: "center",
                end: onRequestClose ? _jsx(SurfaceHeaderCloseButton, {
        ...
        children: [
            _jsx("div", {
                ...
                children: _jsxs("div", {
                    ...
                    ref: composeRefs(containerRef, snapAnimationRef),
                    children: [
                        backdropVisible && onRequestClose != null && _jsx(DismissArea, {
...
function SheetContent(
    ...
    return _jsx(ContentContainer, {
        ref: toCallbackRef(composeRefs(contentRef, contentScrollRef, imperativeScrollRef, scrollPaddingRef, scrollableRef)),
        id: id,
...
const createSheetImperativeHandle = (innerRef, snapPoints, setSnapPointIndex)=>{
    ...
    return {
        ...
        getScrollState: ()=>getScrollState(el),
        scrollTo: (options)=>{
