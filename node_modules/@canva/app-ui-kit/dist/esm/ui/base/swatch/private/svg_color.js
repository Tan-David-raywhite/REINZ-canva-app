...
export const ColorStripes = observer(function ColorStripes({ className, height, width, fills }) {
...
const Svg = observer(function Svg({ className, viewbox: { top, left, height, width }, children }) {
    return _jsx("svg", {
        className: className,
        role: "presentation",
        viewBox: [
...
const SvgRect = observer(function SvgRect({ box: { top, left, height, width }, fill, shapeRendering }) {
    return _jsx("rect", {
...
const SvgGradientDefinition = observer(function SvgGradientDefinition({ gradient, id, box }) {
