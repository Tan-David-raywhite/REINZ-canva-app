...
import { useCustomLinkColorOverride } from './custom_link_color_override';
import styles, { customProperties, getStyle } from './link.css';
import { LinkMessages } from './link.messages';
import { LinkTestIds } from './link.testids';
...
const LinkInner = (props)=>{
    ...
    const customColorOverride = useCustomLinkColorOverride();
    return (_jsxs("a", {
            className: classNames(className, variant === InheritColor ? styles.inheritColor : getStyle(variant), {
                [styles.hoverSupported]: hoverSupported,
                [styles.disabled]: disabled
            }),
            style: {
                [customProperties.linkColor]: disabled ? undefined : customColorOverride
            },
            id: id,
            "data-testid": testId ?? LinkTestIds.link,
