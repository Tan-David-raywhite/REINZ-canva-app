...
export const InternalMasonryContainer = observer(function InternalMasonryContainer({ rows, rowVisibility, presenter, verticalGutterPx, horizontalGutterPx, containerWidth }) {
    let firstVisible = 0;
    let lastVisible = 0;
