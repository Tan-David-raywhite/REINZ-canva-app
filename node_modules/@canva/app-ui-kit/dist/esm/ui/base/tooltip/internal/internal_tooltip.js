...
import { Inline, Rows } from '../../layout/layout';
...
export function TooltipContent(props) {
    ...
    const shortcutElement = shortcuts.length > 0 ? _jsx(Inline, {
        spacing: "0.5u",
        align: align,
        alignY: "center",
        children: shortcuts.map((shortcutCombination, index)=>_jsxs(React.Fragment, {
                children: [
                    _jsx(Shortcut, {
                    ...
                    index < shortcuts.length - 1 && _jsx(Text, {
                        size: "small",
                        tone: "subtle",
                        tagName: "span",
                        children: "/"
...
export function TooltipBox({ className, children, ...props }) {
    return _jsx(Box, {
        ...
        paddingY: "0.5u",
        ...props,
        children: _jsx(ThemeBoundary, {
            light: "dark",
            dark: "dark",
            classicLight: "dark",
            classicDark: "dark",
            children: ({ className: themeClassName })=>_jsx("div", {
                    className: classNames(themeClassName, styles.themeWrapper),
                    children: children
                })
        })
    });
...
export function StatelessTooltip({ children, placement = 'bottom', open, arrow = true, refObj, direction, boundary, ...contentProps }) {
