...
import { useEnableHighColorContrast } from '../../provider/provider';
...
export function Menu({ ref, ...props }) {
    ...
    const menuClassName = classNames(styles.menu, !navigationRole && props.className, getMenuSpaceStyle(props.spacing), getStyle(variant), {
...
export const MenuItemButton = observer(function MenuItemButton({ id, role, alignment, children, className, active, selected, pressed, disabled, draggable, disclosure, onClick, onFocus, onBlur, onMouseEnter, onMouseLeave, onContextMenu, tabIndex, start, end, label, description, lineClamp, buttonRef, tooltipLabel: tooltipLabelProp, tooltipDisabled, tooltipLineClamp, tooltipPlacement, tooltipShortcut, ariaLabel, ariaLabelledBy, ariaDescribedBy, ariaHasPopup, ariaControls, ariaSelected, ariaCurrent, href, target, download }) {
    ...
    const isKeyboardMode = accessModeState.isKeyboardMode;
    const highContrast = useEnableHighColorContrast();
    const labelId = React.useId();
    const descriptionId = React.useId();
    const buttonClassName = classNames(styles.menuItemButton, {
        [styles.isKeyboardMode]: isKeyboardMode,
        [styles.highContrast]: highContrast,
        [styles.hoverSupported]: useIsHoveringInput(),
        [styles.hasStartDecorator]: Boolean(start),
        [styles.hasEndDecorator]: Boolean(end)
    }, className);
    const contentNodes = [];
    if (children != null && !childrenIsTextLike) contentNodes.push(children);
        ...
        textContent !== undefined && contentNodes.push(_jsx(Text, {
            ...
            testId: MenuTestIds.menuItemButtonLabel,
...
export const MenuDivider = React.memo(function MenuDivider({ id, children, borderWidth, inset, spacing }) {
    ...
    return _jsxs("li", {
        role: "none",
        id: id,
        className: styles.menuDividerItem,
        children: [
            _jsx("div", {
