...
export function useScrollableItems(options) {
    const { onScroll: onScrollOption, onScrollStateChange: onScrollStateChangeOption, debounceMs = 0, gap = 0, paddingBefore = 0, paddingAfter = 0, getItemWidth: getItemWidthOption, getItemHeight: getItemHeightOption, itemCount: itemCountOption } = options;
