...
export const ScrollableItems = ({ direction, fadeSize = '6u', gap = '2u', children, id, snap = 'proximity', snapAlign = 'start', snapStop = 'normal', padding, paddingX, paddingY, paddingTop, paddingBottom, paddingStart, paddingEnd, ref, scrollableRef, onScroll: onScrollProp, onScrollStateChange: onScrollStateChangeProp, itemSize = 'intrinsic', outOfViewItemBehavior = 'inert', role, ariaLabel, ariaLabelledBy, ariaDescribedBy, ariaSetSize, getItemWidth, itemCount, onFocus })=>{
    ...
    return _jsx(ScrollableItemsContext, {
        value: contextValue,
...
function useResponsiveUnitValueToPixel(rawValue) {
    ...
    const value = useResponsiveValue(responsiveValue);
    return unitSizeToNumber(value);
}
...
export const ScrollableItem = React.memo(
    function ScrollableItem({ children, snapAlign: itemSnapAlign, snapStop: itemSnapStop, size: itemSizeProp, role: roleProp, index }) {
        const { snapAlign: parentSnapAlign, snapStop: parentSnapStop, role: carouselRole, itemSize: parentItemSize, focusScrollContainer, numberOfItems } = React.useContext(ScrollableItemsContext);
        ...
        const itemClassName = classNames(styles.item, {
            ...
            [styles.snapItemAlways]: snapStop === 'always'
