...
export const TabActivationModeContext = createContext('automatic');
export function useTabActivationMode() {
    return useContext(TabActivationModeContext);
}
export const useTab = ({ id, active: activeProp, onClick: onClickProp, ariaControls: ariaControlsProp, activationMode: activationProp })=>{
...
export const TabsElementsProvider = ({ children })=>{
    ...
    return _jsx(TabsElementsContext, {
        value: {
            elementRefs,
            registerElementRef,
