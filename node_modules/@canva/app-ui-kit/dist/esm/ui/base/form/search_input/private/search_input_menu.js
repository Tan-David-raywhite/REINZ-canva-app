...
import styles, { getStyle } from './search_input_menu.css';
export function SearchInputMenu(props) {
    ...
    return _jsx(OutsidePointerDownHandler, {
        ...
        children: _jsx("div", {
            className: classNames(styles.searchInputMenu, className, getStyle(size), {
