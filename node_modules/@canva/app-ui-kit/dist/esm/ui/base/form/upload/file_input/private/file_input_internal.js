...
export const FileInputInternal = observer(function FileInputInternal({ mode = 'droparea', variant = 'compact', image: imageProp = 'none', multiple, accept, disabled, error, ariaControls, onClick: onClickProp, id, ariaLabelledBy, ariaDescribedBy, stretchButton }) {
