...
import { InputPillTestIds } from './input_pill.testids';
...
export function InputPill(
    { text, tone, disabled, maxWidth = '25u', start, isLoading = false, onRemoveClick, ref }
) {
    ...
    const className = classNames({
        ...
        [shimmerStyles.shimmerOverlay]: isLoading
    });
    ...
    if (isTruncated) return _jsx(Tooltip, {
        ...
        children: ({ tooltipId, ...triggerProps })=>_jsx("span", {
                ...
                ...triggerProps,
                "data-testid": InputPillTestIds.pill,
                children: pill
            })
    });
    return _jsx("span", {
