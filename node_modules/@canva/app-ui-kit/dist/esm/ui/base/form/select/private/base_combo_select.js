...
import { WithDefaultSelectRenderSurface } from './surface';
...
new (_class = class extends _identity {
...
}, prop = (_BaseComboSelect = class BaseComboSelect extends (_React_Component = React.Component) {
    static _makeObservable(instance) {
        makeObservable(instance, {
    ...
    render() {
        ...
        const optionCount = flattenOptions(props.options).length;
        return _jsx(WithDefaultSelectRenderSurface, {
            optionCount: optionCount,
            searchable: true,
            children: (defaultRenderSurface)=>_jsx(BaseSelect, {
                    ...props,
...
export { _BaseComboSelect1 as BaseComboSelect };
