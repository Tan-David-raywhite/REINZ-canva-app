...
import { SegmentedControlTestIds } from './segmented_control.testids';
    ...
    return _jsx("div", {
        ...
        children: _jsx(Grid, {
            ...
            children: options.map((option, index)=>{
                ...
                return _jsx("div", {
                    className: classNames(styles.itemWrapper, active && styles.active, itemDisabled && styles.disabled),
...
function SegmentedControlItem(props) {
    ...
    return _jsx(Observer, {
        children: ()=>_jsx(BaseButton, {
                ...
                testId: SegmentedControlTestIds.item,
                disabled: disabled,
                role: "radio",
                ariaLabel: ariaLabel,
                id: id,
                ...
                tone: "tertiary",
                color: {
                    default: active ? styles.scItemSelectedFg : styles.scItemFg,
