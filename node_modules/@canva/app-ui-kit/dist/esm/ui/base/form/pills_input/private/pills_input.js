...
import { makeObservable } from '../../../../../platforms/libs/mobx/make_observable';
...
import styles, { customProperties, getStyle } from './pills_input.css';
import { PillInputMessages } from './pills_input.messages';
import { PillsInputTestIds } from './pills_input.testids';
                    ...
                    children: ()=>_jsxs("div", {
                            ...
                            children: [
                                _jsx("input", {
                                    ...
                                    "data-testid": PillsInputTestIds.input
                                }),
                                _jsx("div", {
...
new (_class = class extends _identity {
...
}, prop = (_PillsInput = class PillsInput extends (_React_Component = React.Component) {
    ...
    render() {
        ...
        const containerClassName = classNames(styles.multiSearchInput, getStyle(size), {
            [styles.disabled]: disabled,
            [styles.borders]: !borderless,
            [styles.focused]: this.isFocused && !disabled,
            [styles.keyboardMode]: accessModeState.isKeyboardMode,
            [styles.error]: error,
            [shimmerStyles.shimmerOverlay]: this.props.loading
        });
        const content = _jsxs("div", {
            ...
            children: [
                items.map((item, i)=>{
                    const start = item.start ?? (item.icon ? _jsx(item.icon, {
                        size: "small"
                    }) : undefined);
                    return _jsx("div", {
        ...
        return (_jsxs("div", {
                ...
                "data-testid": PillsInputTestIds.multiSearchInput,
                children: [
                    ...
                    this.shouldRenderClearButton() ? _jsx("div", {
    ...
    constructor(...args){
        super(...args), this.dynamicSizeInputRef = (_PillsInput1._makeObservable(this), React.createRef()), this.inputRef = React.createRef(), this.srStatusStrings = [], this.isFocused = false, this.onMouseDown = action((event)=>{
...
export { _PillsInput1 as PillsInput };
