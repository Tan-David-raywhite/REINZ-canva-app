...
export const FlyoutMenuDivider = MenuDivider;
            ...
            children: _jsx(AdaptivePopover, {
                ...
                children: _jsx(Menu, {
                    ...
                    className: classNames(styles.flyoutMenuContent, {
                        [styles.regularRound]: variant === 'regularRounded',
                        [styles.compactRound]: variant === 'compactRounded'
                    }),
                    ariaLabelledBy: id,
                    variant: variant,
...
export const FlyoutMenu = observer(function FlyoutMenu(props) {
...
export const NestedFlyoutMenuButton = React.memo(function NestedFlyoutMenuButton(props) {
