...
import { CustomLinkColorOverrideProvider } from '../../link/custom_link_color_override';
...
import { AlertTestIds } from './alert.testids';
...
export const Alert = ({ children, className, title, tone, dismissible, onDismiss, size = 'medium', rounded = true, showIcon = size !== 'small', Icon, focusRef, testId })=>{
    ...
    return _jsx(Box, {
        ...
        testId: testId ?? AlertTestIds.alert,
        role: "note",
        ref: composeRefs(containerRef, announcerRef),
        tabIndex: focusRef != null ? -1 : undefined,
        children: _jsx(CustomLinkColorOverrideProvider, {
