...
export function useViewportContainerSizeEffect(callback, threshold) {
    ...
    useIsomorphicLayoutEffect(()=>{
        ...
        const frameElement = globalWindow?.frameElement;
        const parentWindow = frameElement?.ownerDocument.defaultView;
        const intersectionObserver = threshold != null && frameElement && parentWindow?.IntersectionObserver ? new parentWindow.IntersectionObserver(()=>onVisualViewportChange(), {
            threshold
        }) : undefined;
        if (frameElement) intersectionObserver?.observe(frameElement);
        return ()=>{
