...
import { toEaselDirection } from './app_ui_provider';
/** 
 ...
 */ export function TestAppUiProvider({ children, theme = 'light', direction = 'LTR', enableAnimations = true }) {
    ...
    return _jsxs(EaselProvider, {
        ...
        direction: toEaselDirection(direction),
        disableFocusTraps: true,
        enableUserSelection: false,
        disableDialogBlur: !enableAnimations,
        autoplayVideos: enableAnimations ? undefined : 'DONT_AUTOPLAY',
        children: [
            _jsx(ApplyThemeRoot, {
                appearance: theme,
                classicLight: theme,
