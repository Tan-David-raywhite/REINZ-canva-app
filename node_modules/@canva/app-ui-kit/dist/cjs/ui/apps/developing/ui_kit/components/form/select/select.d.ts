...
export type CustomizableSelectTriggerProps<T> = {
    ...
    /** 
         ...
         *
         * @deprecated The `className` supplied to the trigger is deprecated and will be removed in a future major release.
         */
    className?: string;
    /** 
...
export type CustomizableSelectItemProps<T> = {
    ...
    /** 
         ...
         *
         * @deprecated The `className` supplied to the item is deprecated and will be removed in a future major release.
         */
    className?: string;
    /** 
