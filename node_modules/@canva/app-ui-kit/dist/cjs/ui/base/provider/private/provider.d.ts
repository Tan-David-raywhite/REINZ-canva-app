...
import type { EaselFlags } from '../../flags/flags';
...
type EaselFlagOverrides = Partial<Pick<EaselFlags, 'enableButtonLoadingScan'>>;
export declare function EaselProvider({ enableAnimations, direction, disableFocusTraps, enableUserSelection, theme, enableHighColorContrast, autoplayVideos, disableDialogBlur, enableButtonLoadingScan, expectedPixelsPerRem, children, }: EaselConfiguration & EaselFlagOverrides & {
