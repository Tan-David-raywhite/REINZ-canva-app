...
const InternalMasonryContainer = (0, _mobxreactlite.observer)(function InternalMasonryContainer({ rows, rowVisibility, presenter, verticalGutterPx, horizontalGutterPx, containerWidth }) {
    let firstVisible = 0;
    let lastVisible = 0;
...
const Row = ({ row, index, height, margin, horizontalGutterPx, containerWidth = 0, debounceElement })=>{
    ...
    return (0, _jsxruntime.jsxs)("div", {
        ...
        children: [
            ...
            (row.Footer || hasExpandableFooter || hasNonExpandableFooter) && (0, _jsxruntime.jsx)(_measure.Measure, {
                client: true,
