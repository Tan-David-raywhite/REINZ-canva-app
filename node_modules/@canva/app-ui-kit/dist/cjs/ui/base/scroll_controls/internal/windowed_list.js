...
Object.defineProperty(exports, "WindowedList", {
    enumerable: true,
    get: function() {
        return _WindowedList1;
    }
});
...
var _WindowedList, _class;
var _initClass, _React_Component;
let _WindowedList1;
let prop;
new (_class = class extends _identity {
    constructor(){
        super(_WindowedList1), _initClass();
    }
}, prop = (_WindowedList = class WindowedList extends (_React_Component = _react.Component) {
    static _makeObservable(instance) {
        (0, _make_observable.makeObservable)(instance, {
            visibleRange: _mobx.observable.shallow,
            itemPositions: _mobx.computed
        });
    }
    get itemPositions() {
    ...
    componentDidMount() {
        (0, _dispose_on_unmount.disposeOnUnmount)(this, (0, _mobx.reaction)(()=>({
            ...
            if (positions == null) this.visibleRange = undefined;
            else {
                const { overscan = 1 } = this.props;
                const { containerSize, scrollPosition } = positions;
            ...
            delay: this.props.throttledUpdateMs
        }));
    }
    setVisibleRange(firstVisible, lastVisible) {
        if (this.visibleRange == null) this.visibleRange = {
            firstVisible,
            lastVisible
        };
        else {
    ...
    render() {
        const { visibleRange, itemPositions } = this;
        if (visibleRange == null) return this.props.children(undefined, itemPositions);
    ...
    constructor(...args){
        super(...args), this.visibleRange = (_WindowedList1._makeObservable(this), undefined);
    }
}, ({ c: [_WindowedList1, _initClass] } = _apply_decs_2203_r(_WindowedList, [], [
    _observer_for_class.observerForClass
], _React_Component)), _WindowedList), _class)();
