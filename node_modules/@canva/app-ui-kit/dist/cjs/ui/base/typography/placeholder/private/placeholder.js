...
const TextPlaceholder = _react.memo(function TextPlaceholder(props) {
    return (0, _jsxruntime.jsx)(TextPlaceholderComponent, {
        ...props,
        variant: "body"
    });
});
const TitlePlaceholder = _react.memo(function TitlePlaceholder(props) {
    return (0, _jsxruntime.jsx)(TextPlaceholderComponent, {
        ...props,
        variant: "title"
    });
});
const DisplayPlaceholder = _react.memo(function DisplayPlaceholder(props) {
    return (0, _jsxruntime.jsx)(TextPlaceholderComponent, {
        ...props,
        variant: "display"
    });
...
function TextPlaceholderComponent({ size = 'medium', variant, index, disableAnimations }) {
    ...
    return (0, _jsxruntime.jsx)("div", {
        ...
        children: (0, _jsxruntime.jsx)(_placeholder.LegacyPlaceholder, {
            shape: "textRectangle",
            index: index,
