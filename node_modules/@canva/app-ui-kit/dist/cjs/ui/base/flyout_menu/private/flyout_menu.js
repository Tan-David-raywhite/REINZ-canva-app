...
_export(exports, {
    ...
    get NestedFlyoutMenuButton () {
        return NestedFlyoutMenuButton;
    },
...
const _flyout_menutestids = require("./flyout_menu.testids");
...
const FlyoutMenuDivider = _menu.MenuDivider;
function getFlyoutMenuSpacing(variant) {
    switch(variant){
        case 'compact':
        case 'compactRounded':
            return '0.25u';
...
function StatelessFlyoutMenu(props) {
    ...
    const composedHeader = title === undefined ? header : (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
        children: [
    ...
    return (0, _jsxruntime.jsx)(TagName, {
        ...
        className: className,
        role: role,
        "data-testid": _flyout_menutestids.FlyoutMenuTestIds.triggerContainer,
        children: (0, _jsxruntime.jsx)("div", {
            children: (0, _jsxruntime.jsx)(_popover.AdaptivePopover, {
                open: open,
                ...
                width: popoverWidth,
                maxWidth: "52u",
                borderRadius: variant === 'compactRounded' ? 'containerSharp' : 'container',
                ...
                children: (0, _jsxruntime.jsx)(_menu.Menu, {
                    ...
                    className: (0, _classnames.default)(_flyout_menucss.default.flyoutMenuContent, {
                        [_flyout_menucss.default.regularRound]: variant === 'regularRounded',
                        [_flyout_menucss.default.compactRound]: variant === 'compactRounded'
                    }),
                    ariaLabelledBy: id,
                    variant: variant,
                    spacing: getFlyoutMenuSpacing(variant),
...
const FlyoutMenu = (0, _mobxreactlite.observer)(function FlyoutMenu(props) {
    ...
    return (0, _jsxruntime.jsx)(FlyoutMenuContext.Provider, {
        ...
        children: (0, _jsxruntime.jsx)(StatelessFlyoutMenu, {
            ...
            popoverOffset: isNested ? {
                ...
                cross: isRounded ? -(_metrics.baseUnit / 2) : -_metrics.baseUnit
            } : props.popoverOffset,
...
function FlyoutMenuContent(props) {
    const parentStore = (0, _flyout_menu_util.useFlyoutMenuStore)();
    const FlyoutMenuContext = (0, _flyout_menu_util.useFlyoutMenuContext)(props.store);
...
const NestedFlyoutMenuButton = _react.memo(function NestedFlyoutMenuButton(props) {
    ...
    _react.useImperativeHandle(handleRef, ()=>(0, _handle.createBasicHTMLHandle)(buttonRef), []);
