...
const _shimmer = require('../../shimmer/shimmer');
...
const _buttontestids = require("./button.testids");
...
const getButtonContent = (props)=>{
    ...
    const effectiveIconSize = props.iconSize ?? (props.size === 'xlarge' ? 'large' : 'medium');
    const content = [];
    ...
    if (props.loading) content.push((0, _jsxruntime.jsxs)("span", {
        className: _buttoncss.default.loadingIconWrapper,
        "data-testid": _buttontestids.ButtonTestIds.loadingIconWrapper,
        children: [
...
const getShimmerOverlayColorClass = (variant, disabled)=>{
    if (disabled && variant !== 'contrast') return _shimmer.shimmerStyles.shimmerOverlayColorDisabled;
    switch(variant){
        case 'primary':
        case 'contrast':
        case 'critical':
            return _shimmer.shimmerStyles.shimmerOverlayColorSaturated;
        default:
            return undefined;
    }
};
const useClassName = (isAnchor, { children, alignment = 'center', active, selected, pressed, disableActiveStyle, disclosure, loading, loadingVariant, disabled, displayType, stretch, variant, hideOutline, iconPosition, shape, size, elevation, expandClickableArea, icon, iconSize })=>{
    ...
    const enableButtonLoadingShimmer = (0, _flags.useEaselFlags)().enableButtonLoadingScan;
    loadingVariant ?? (loadingVariant = enableButtonLoadingShimmer ? 'shimmer' : 'spinner');
    return (0, _classnames.default)(_buttoncss.default.base, {
        ...
        [_buttoncss.default.displayBlock]: displayType === 'block',
        ...
        [_buttoncss.default.resting]: elevation === 'resting',
        [_buttoncss.default.raised]: elevation === 'raised',
        ...
        [_buttoncss.default.hideLoadingIndicator]: loading && loadingVariant === 'shimmer',
        [_shimmer.shimmerStyles.shimmerOverlay]: loading && loadingVariant === 'shimmer',
        ...
        [_buttoncss.default.xlargeWidth]: trueSize === 'xlarge' && squareSizing
    }, loading && loadingVariant === 'shimmer' && getShimmerOverlayColorClass(variant, disabled));
};
...
function getDefaultElevation(variant) {
    switch(variant){
        case 'primary':
        case 'critical':
        case 'contrast':
...
const ButtonInner = (0, _mobxreactlite.observer)(function ButtonInner({ ref, displayType = 'inline', ...props }) {
    const buttonRef = _react.useRef(null);
    _react.useImperativeHandle(ref, ()=>(0, _handle.createBasicHTMLHandle)(buttonRef), []);
    const composedRef = (0, _compose_refs.composeRefs)(buttonRef, (0, _callback_ref.toCallbackRef)(props.buttonRef));
    ...
    const elevationProp = props.elevation ?? (props.elevated ? 'raised' : undefined);
    const elevation = elevationProp ?? getDefaultElevation(props.variant);
    const enableSolidBackground = elevation !== 'none' && (props.variant === 'secondary' || props.variant === 'tertiary');
    ...
    return (0, _jsxruntime.jsx)(ElevatedWrapper, {
        ...
        children: (0, _jsxruntime.jsx)("button", {
            ...
            "data-testid": props.testId ?? _buttontestids.ButtonTestIds.base,
            form: props.form,
...
const AnchorInner = (0, _mobxreactlite.observer)(function AnchorInner({ ref, displayType = 'inline', ...props }) {
    const anchorRef = _react.useRef(null);
    _react.useImperativeHandle(ref, ()=>(0, _handle.createBasicHTMLHandle)(anchorRef), []);
    const composedRef = (0, _compose_refs.composeRefs)(anchorRef, (0, _callback_ref.toCallbackRef)(props.buttonRef));
...
function CircleButtonWithLabel({ variant, children, tooltipLabel: tooltipLabelProp, ref, id, ...props }) {
    const defaultButtonId = _react.useId();
    const buttonId = id ?? defaultButtonId;
...
function getSize({ children, iconSize, size, variant }) {
    ...
    if (!children && iconSize && [
        ...
        'small',
        'large'
    ].indexOf(iconSize) !== -1) return iconSize === 'large' ? 'xlarge' : iconSize;
    return 'medium';
}
const ElevatedWrapper = (0, _mobxreactlite.observer)(function ElevatedWrapper(props) {
    if (props.enabled && props.elevation !== 'none') return (0, _jsxruntime.jsx)("span", {
        className: (0, _classnames.default)(_buttoncss.default.elevatedWrapper, props.containerClassName, {
            [_buttoncss.default.stretch]: props.stretch,
            [_buttoncss.default.displayBlock]: props.displayType === 'block',
            [_buttoncss.default.tinyElevatedWrapper]: props.size === 'tiny',
            [_buttoncss.default.xsmallElevatedWrapper]: props.size === 'xsmall',
            [_buttoncss.default.smallElevatedWrapper]: props.size === 'small',
            [_buttoncss.default.largeElevatedWrapper]: props.size === 'large',
            [_buttoncss.default.xlargeElevatedWrapper]: props.size === 'xlarge',
            [_buttoncss.default.circleShape]: props.shape === 'circle',
            [_buttoncss.default.resting]: props.elevation === 'resting',
            [_buttoncss.default.raised]: props.elevation === 'raised'
        }),
