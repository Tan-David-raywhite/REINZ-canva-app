...
type SurfaceHeaderContextType = Pick<SurfaceHeaderProps, 'alignment'>;
export declare const SurfaceHeaderContextProvider: React.Provider<SurfaceHeaderContextType | undefined>;
export declare const SurfaceHeader: ({ title, titleId, description, descriptionId, alignment, start, end, divider, padding, background, }: SurfaceHeaderProps) => React.JSX.Element;
