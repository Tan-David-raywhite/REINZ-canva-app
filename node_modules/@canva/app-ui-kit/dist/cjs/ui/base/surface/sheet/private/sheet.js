...
const _dismiss_area = require('../../internal/dismiss_area/dismiss_area');
...
const transitionDurationMs = parseInt(_sheetcss.default.transitionTime, 10);
function Sheet({ open, id: idProp, onOpenComplete, onCloseComplete, onBackButton, backdropVisible = true, markOutsideInert = backdropVisible, trigger, ref, ...inner }) {
    ...
    return (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
        children: [
            ...
            (0, _jsxruntime.jsx)(_layer.Layer, {
                open: transition.rendering,
                markOutsideInert: markOutsideInert,
                children: (0, _jsxruntime.jsx)("div", {
                    className: (0, _classnames.default)({
                        [_sheetcss.default.transitioning]: transition.animated && !transition.open,
                        [_sheetcss.default.visible]: transition.opening || transition.open
                    }),
...
function SheetInner({ handleRef, height = 'auto', scrollToResizeBelow, onHeightChange, onRequestClose, onScroll, backdropVisible, handleSafeAreaInsetBottom = true, animateResize, id, children, header, headerDivider = 'always', footer, footerDivider = 'never', handleVisible = 'auto', _tempVideoOnlyIgnoreVirtualKeyboardOffset = false, ariaDescribedBy, ariaLabel, ariaLabelledBy, autoFocus, captureFocus, role }) {
    const heights = _react.useMemo(()=>ensureArray(height), [
        height
    ]);
    _preconditions.Preconditions.checkArgument(heights.length > 0, 'Sheets require at least one height value');
    const isDismissible = onRequestClose != null;
    const snapPoints = _react.useMemo(()=>[
    ...
    _react.useImperativeHandle(handleRef, ()=>createSheetImperativeHandle(contentRef, snapPoints, setSnapPointIndex), [
        setSnapPointIndex,
        snapPoints
    ]);
    const { handleSnap, cancelSnap, scheduleUpdate, setDragOffset, ref: snapAnimationRef } = (0, _behavior.useSheetPositioner)(animateResize);
    const { resizing, controls } = (0, _behavior.useSheetControls)({
        snapPoints,
        snapPointIndex,
        setSnapPointIndex: (index)=>{
            footerRef.current?.style.setProperty('transform', '');
        ...
        setOffset: (offset, snapPointHeight)=>scheduleUpdate(()=>{
                ...
                if (finalOffset != null) setDragOffset(finalOffset);
    ...
    const { ref: scrollableRef, onScroll: onScrollableScroll, showHeaderBorder: showHeaderDivider, showFooterBorder: showFooterDivider } = (0, _surface_dividers.useSurfaceDividers)({
        headerDivider,
        footerDivider
    });
    ...
    const hasDecorations = header != null || footer != null;
    if (hasDecorations) content = (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
        children: [
            header != null && (0, _jsxruntime.jsx)(_header.SurfaceHeaderContextProvider, {
                alignText: "center",
                end: onRequestClose ? (0, _jsxruntime.jsx)(_header.SurfaceHeaderCloseButton, {
            ...
            footer != null && (0, _jsxruntime.jsx)("div", {
                className: (0, _classnames.default)(_sheetcss.default.footer, {
                    [_sheetcss.default.footerBorder]: showFooterDivider
                }),
        ...
        children: [
            (0, _jsxruntime.jsx)("div", {
                ...
                children: (0, _jsxruntime.jsxs)("div", {
                    ...
                    ref: (0, _compose_refs.composeRefs)(containerRef, snapAnimationRef),
                    children: [
                        backdropVisible && onRequestClose != null && (0, _jsxruntime.jsx)(_dismiss_area.DismissArea, {
...
function SheetContent(
    { controls, scrollToResizeBelow, handleSafeAreaInsetBottom, onScroll, id, children, scrollPaddingRef, scrollableRef, ref: imperativeScrollRef, ariaDescribedBy, ariaLabel, ariaLabelledBy, autoFocus, captureFocus, role }
) {
    ...
    return (0, _jsxruntime.jsx)(_content_container.ContentContainer, {
        ref: (0, _callback_ref.toCallbackRef)((0, _compose_refs.composeRefs)(contentRef, contentScrollRef, imperativeScrollRef, scrollPaddingRef, scrollableRef)),
        id: id,
...
const createSheetImperativeHandle = (innerRef, snapPoints, setSnapPointIndex)=>{
    ...
    return {
        ...
        getScrollState: ()=>(0, _scroll.getScrollState)(el),
        scrollTo: (options)=>{
            if (typeof options === 'number') el.scrollTo(0, options);
            else el.scrollTo(options);
        },
        scrollBy: (options)=>{
            if (typeof options === 'number') el.scrollBy(0, options);
