...
_export(exports, {
    get TabActivationModeContext () {
        return TabActivationModeContext;
    },
    get TabsContext () {
        return TabsContext;
    },
    ...
    get useTabActivationMode () {
        return useTabActivationMode;
    },
    get useTabList () {
        return useTabList;
    },
...
const TabActivationModeContext = (0, _react.createContext)('automatic');
function useTabActivationMode() {
    return (0, _react.useContext)(TabActivationModeContext);
}
const useTab = ({ id, active: activeProp, onClick: onClickProp, ariaControls: ariaControlsProp, activationMode: activationProp })=>{
    const context = useTabsContext();
    const contextActivation = useTabActivationMode();
    const activation = activationProp ?? contextActivation;
...
const useTabPanel = ({ id, active: activeProp, ariaLabelledBy: ariaLabelledByProp, children: childrenProp, contentRenderStrategy = 'lazy' })=>{
    ...
    const cacheRef = (0, _cache.useCache)();
    if (contentRenderStrategy === 'lazy') {
        if (active) cacheRef.current.set(id, children);
...
const TabsElementsProvider = ({ children })=>{
    ...
    return (0, _jsxruntime.jsx)(TabsElementsContext, {
        value: {
            elementRefs,
            registerElementRef,
...
function useTabsElements() {
    ...
    return {
        ...
        unregisterElementRef: context?.unregisterElementRef,
