...
const ColorStripes = (0, _mobxreactlite.observer)(function ColorStripes({ className, height, width, fills }) {
...
const Svg = (0, _mobxreactlite.observer)(function Svg({ className, viewbox: { top, left, height, width }, children }) {
...
const SvgRect = (0, _mobxreactlite.observer)(function SvgRect({ box: { top, left, height, width }, fill, shapeRendering }) {
    return (0, _jsxruntime.jsx)("rect", {
...
const SvgGradientDefinition = (0, _mobxreactlite.observer)(function SvgGradientDefinition({ gradient, id, box }) {
