...
const FileInputItem = (props)=>{
    const { label, onDeleteClick, disabled, start, tagName = 'div' } = props;
    const startDecorator = typeof start === 'function' ? start() : start;
        ...
        children: (0, _jsxruntime.jsxs)(_layout.Columns, {
            ...
            children: [
                (0, _jsxruntime.jsx)(_layout.Column, {
                    width: "content",
                    children: startDecorator ?? (0, _jsxruntime.jsx)(_icon.CloudUploadIcon, {
                        size: "medium",
