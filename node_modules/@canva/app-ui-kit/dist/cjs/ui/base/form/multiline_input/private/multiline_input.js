...
function useAutoGrow(
    ...
    const [rows, setRows] = _react.useState();
    const remeasure = _react.useCallback(()=>{
    ...
    (0, _use_isomorphic_layout_effect.useIsomorphicLayoutEffect)(remeasure, [
        remeasure,
        value
    ]);
    const stableRemeasure = _react.useRef(remeasure);
    (0, _use_isomorphic_layout_effect.useIsomorphicLayoutEffect)(()=>{
        stableRemeasure.current = remeasure;
    }, [
        remeasure
    ]);
    const observerRef = _react.useRef(null);
    const setRef = _react.useCallback((element)=>{
        if (observerRef.current == null)
            observerRef.current = new _resizeobserverpolyfill.default(()=>stableRemeasure.current());
...
const MultilineInput = (0, _mobxreactlite.observer)(function MultilineInput({ ref, ...props_ }) {
    const { props, setPropOverrides } = (0, _input.usePropOverrides)(props_);
    const { onChange: onChangeProp, onFocus: onFocusProp, onBlur: onBlurProp, onChangeComplete: onChangeCompleteProp, onKeyDown: onKeyDownProp, onRowsChange: onRowsChangeProp, dir = 'auto', autoGrow, size = 'medium' } = props;
    const { ref: inputRef, onClick: onWrapperClick } = (0, _base_input.useOnWrapperClick)();
    const { isFocused, isKeyboardMode, setFocused } = (0, _base_input.useFocusState)();
    ...
    const wrapperClassName = (0, _classnames.default)(_temporary_exportscss.default.wrapper, _multiline_inputcss.default.multilineWrapper, {
        [_temporary_exportscss.default.hoverSupported]: hoverSupported,
        [_temporary_exportscss.default.focusOutline]: isFocused && isKeyboardMode,
        [_temporary_exportscss.default.borderless]: props.borderless
    }, props.disabled && _temporary_exportscss.default.disabled || isFocused && _temporary_exportscss.default.active || props.error && _temporary_exportscss.default.error, !props.autoGrow && props.resize && _multiline_inputcss.default.resize, props.className);
    const inputClassName = (0, _classnames.default)(_temporary_exportscss.default.textField, _multiline_inputcss.default.multilineTextField, (0, _multiline_inputcss.getStyle)(size), props.inputClassName);
    return ((0, _jsxruntime.jsx)("div", {
            ...
            children: (0, _jsxruntime.jsxs)(_input.BaseInputContextProvider, {
                ...
                children: [
                    ...
                    autoGrow && (0, _jsxruntime.jsx)("textarea", {
                        "aria-hidden": "true",
                        className: (0, _classnames.default)(inputClassName, _multiline_inputcss.default.hiddenInput),
                        dir: dir,
                        ref: autoGrowRef,
                        readOnly: true,
                        rows: 1,
