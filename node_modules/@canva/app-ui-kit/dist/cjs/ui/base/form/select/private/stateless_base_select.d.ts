...
import type { TriggerProps } from '../../../surface/popover/popover';
...
export type ScrollContainer = ScrollHandle & LayoutHandle;
...
export type StatelessBaseSelectProps<T> = {
    ...
    stretch?: boolean
    focusOnMenu?: boolean
    isMenuContainerFocusable?: boolean
    id?: string
    ariaLabel?: string
...
export type SelectMenuHeaderRenderProps = {
    isScrolled: boolean
...
export type BaseSelectMenuProps<T> = Pick<StatelessBaseSelectProps<T>, 'Item' | 'item' | 'value' | 'options' | 'activeIndex' | 'ariaLabel' | 'ariaLabelledBy' | 'onItemClick' | 'onItemHover' | 'menuContainerRef'> & PickRequired<StatelessBaseSelectProps<T>, 'areEqual' | 'isSelected' | 'getLabel' | 'flatOptions' | 'optionGroups' | 'selectedOptions'> & {
    ...
    id: string
    className?: string
    header?: React.ReactNode | ((props: SelectMenuHeaderRenderProps) => React.ReactNode)
    footer?: React.ReactNode
    children?: React.ReactNode
    isScrolled?: boolean
    sheetScrollRef?: React.RefObject<ScrollContainer | null>
};
...
export type WindowedSelectMenuProps<T> = BaseSelectMenuProps<T> & {
    itemHeightMultiplier?: number | ((option: SelectOption<T>, itemIndex: number) => number)
};
export declare function WindowedSelectMenu<T>(props: WindowedSelectMenuProps<T>): React.JSX.Element;
export declare function renderEmptyMenuContent(searchQuery?: string): React.JSX.Element;
