...
function RadioGroup(props) {
    ...
    _react.useImperativeHandle(ref, ()=>(0, _handle.composeHandles)((0, _handle.createDOMElementHandle)(radioGroupRef), (0, _handle.createLayoutHandle)(radioGroupRef), (0, _handle.createNodeHandle)(radioGroupRef), (0, _handle.createScrollHandle)(radioGroupRef), (0, _handle.createTraverseHandle)(radioGroupRef), (0, _handle.createFocusHandle)(variant === 'button' ? radioGroupRef : currentFocusRef)), [
        variant
    ]);
...
function ButtonRadioGroup(props) {
    ...
    _react.useImperativeHandle(ref, ()=>(0, _handle.composeHandles)((0, _handle.createDOMElementHandle)(divRef), (0, _handle.createLayoutHandle)(divRef), (0, _handle.createNodeHandle)(divRef), (0, _handle.createScrollHandle)(divRef), (0, _handle.createTraverseHandle)(divRef), (0, _handle.createFocusHandle)(activeRef)), []);
    _react.useEffect(()=>{
