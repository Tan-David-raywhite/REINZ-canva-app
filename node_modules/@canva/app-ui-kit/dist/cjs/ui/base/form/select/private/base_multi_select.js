...
class BaseMultiSelect extends _react.Component {
    ...
    render() {
        ...
        const optionCount = (0, _base_select_util.flattenOptions)(options).length;
        return (0, _jsxruntime.jsx)(_surface.WithDefaultSelectRenderSurface, {
            ...
            children: (defaultRenderSurface)=>(0, _jsxruntime.jsx)(_base_select.BaseSelect, {
                    ...
                    headerEnd: (0, _popover.getTypicalSheetAdaptation)() && (0, _jsxruntime.jsx)(_header.SurfaceHeaderTextButton, {
                    ...
                    renderSurface: this.props.renderSurface ?? defaultRenderSurface
                })
        });
    }
    constructor(...args){
