...
const _search_input_menucss = _interop_require_wildcard(require("./search_input_menu.css"));
...
function SearchInputMenu(props) {
    const { children, detachContent = false, border, size: sizeProp, onOutsidePointerDown, end, className, error, type = 'search', usePopover = false, captureFocus, ref, ...searchInputProps } = props;
    ...
    return (0, _jsxruntime.jsx)(_outside_pointerdown_handler.OutsidePointerDownHandler, {
        ...
        children: (0, _jsxruntime.jsx)("div", {
            className: (0, _classnames.default)(_search_input_menucss.default.searchInputMenu, className, (0, _search_input_menucss.getStyle)(size), {
