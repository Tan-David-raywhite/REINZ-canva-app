...
_export(exports, {
    ...
    get ITEM_WITH_DESCRIPTION_HEIGHT_MULTIPIER () {
        return ITEM_WITH_DESCRIPTION_HEIGHT_MULTIPIER;
    },
    get Menu () {
        return Menu;
    },
...
const _menutestids = require("./menu.testids");
...
const ITEM_WITH_DESCRIPTION_HEIGHT_MULTIPIER = 7.25;
const DIVIDER_HEIGHT_MULTIPIER = 2;
const TEXT_DIVIDER_HEIGHT_MULTIPIER = 4;
const getMenuSpaceStyle = (spacing)=>{
    switch(spacing){
        case '0.25u':
            return (0, _menucss.getStyle)('spacing025');
        case '0.5u':
            return (0, _menucss.getStyle)('spacing050');
        case '1u':
            return (0, _menucss.getStyle)('spacing1');
        case '0':
            return (0, _menucss.getStyle)('spacing0');
        default:
            return;
    }
};
function Menu({ ref, ...props }) {
    ...
    const menuClassName = (0, _classnames.default)(_menucss.default.menu, !navigationRole && props.className, getMenuSpaceStyle(props.spacing), (0, _menucss.getStyle)(variant), {
    ...
    const content = (0, _jsxruntime.jsx)(_box.Box, {
        ...
        testId: _menutestids.MenuTestIds.menu,
    ...
    return (0, _jsxruntime.jsx)(MenuContext, {
        value: context,
        children: maybeWrappedContent
    });
}
function getMenuItemRoles(menuRole, role) {
    switch(menuRole){
        case 'menu':
        case 'menubar':
            return {
                boxRole: 'none',
                buttonRole: role ?? 'menuitem'
            };
        case 'listbox':
        case 'group':
            return {
...
const MenuItem = _react.memo(
    function MenuItem({ id, role, children, className, active, selected, pressed, disabled, disclosure, draggable, onFocus, onBlur, onMouseEnter, onMouseLeave, tabIndex, start, end, label, description, lineClamp, buttonRef, tooltipLabel, tooltipDisabled, tooltipLineClamp, tooltipPlacement, tooltipShortcut, ariaLabel, ariaLabelledBy, ariaDescribedBy, ariaHasPopup, ariaControls, ariaSelected, ariaCurrent, href, target, download, onClick, onContextMenu }) {
        ...
        const { boxRole, buttonRole } = getMenuItemRoles(context.menuRole, role);
        const [boxId, buttonId] = boxRole === 'none' ? [
            undefined,
            id
        ] : [
            id,
...
const MenuItemButton = (0, _mobxreactlite.observer)(function MenuItemButton({ id, role, alignment, children, className, active, selected, pressed, disabled, draggable, disclosure, onClick, onFocus, onBlur, onMouseEnter, onMouseLeave, onContextMenu, tabIndex, start, end, label, description, lineClamp, buttonRef, tooltipLabel: tooltipLabelProp, tooltipDisabled, tooltipLineClamp, tooltipPlacement, tooltipShortcut, ariaLabel, ariaLabelledBy, ariaDescribedBy, ariaHasPopup, ariaControls, ariaSelected, ariaCurrent, href, target, download }) {
    ...
    const isKeyboardMode = _access_mode_state.accessModeState.isKeyboardMode;
    const highContrast = (0, _provider.useEnableHighColorContrast)();
    ...
    const buttonClassName = (0, _classnames.default)(_menucss.default.menuItemButton, {
        [_menucss.default.isKeyboardMode]: isKeyboardMode,
        [_menucss.default.highContrast]: highContrast,
        [_menucss.default.hoverSupported]: (0, _pointer_input_state.useIsHoveringInput)(),
        [_menucss.default.hasStartDecorator]: Boolean(start),
        [_menucss.default.hasEndDecorator]: Boolean(end)
    }, className);
    const contentNodes = [];
    if (children != null && !childrenIsTextLike) contentNodes.push(children);
        ...
        textContent !== undefined && contentNodes.push((0, _jsxruntime.jsx)(_typography.Text, {
            ...
            testId: _menutestids.MenuTestIds.menuItemButtonLabel,
    ...
    return (0, _jsxruntime.jsx)(Clickable, {
        ...
        tone: "tertiary",
        backgroundColor: {
            hovered: highContrast && !active && !selected ? 'transparent' : undefined
        },
        children: decoratedContent
    });
});
...
const MenuDivider = _react.memo(function MenuDivider({ id, children, borderWidth, inset, spacing }) {
    ...
    const isRoundedMenu = context.menuVariant === 'regularRounded' || context.menuVariant === 'compactRounded';
    const isHorizontalMenu = context.menuDirection === 'horizontal';
    const resolvedInset = inset ?? (isHorizontalMenu || isRoundedMenu ? '1u' : 'none');
    const resolvedSpacing = spacing ?? (context.menuVariant === 'compactRounded' ? '0.5u' : '1u');
    return (0, _jsxruntime.jsxs)("li", {
        role: "none",
        id: id,
        className: _menucss.default.menuDividerItem,
        children: [
