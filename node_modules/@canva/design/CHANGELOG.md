...
- Promoted the Multi-Page Editing functionality of `design.openDesign` from Beta to GA.

## 2.9.0 - 2026-05-27

### Added

- Added `design.getDesignTemplateMetadata` which was previously in preview. This API method returns information about the templates that were used in a design.
